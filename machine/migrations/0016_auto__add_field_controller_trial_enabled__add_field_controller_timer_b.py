...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Controller.trial_enabled'
        db.add_column(u'machine_controller', 'trial_enabled',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'Controller.timer_based'
        db.add_column(u'machine_controller', 'timer_based',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=100),
                      keep_default=False)

        # Adding field 'Controller.trial_period'
        db.add_column(u'machine_controller', 'trial_period',
                      self.gf('django.db.models.fields.IntegerField')(default=1, max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Controller.trial_enabled'
        db.delete_column(u'machine_controller', 'trial_enabled')

        # Deleting field 'Controller.timer_based'
        db.delete_column(u'machine_controller', 'timer_based')

        # Deleting field 'Controller.trial_period'
        db.delete_column(u'machine_controller', 'trial_period')
