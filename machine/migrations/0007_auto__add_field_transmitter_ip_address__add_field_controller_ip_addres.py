...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transmitter.ip_address'
        db.add_column(u'machine_transmitter', 'ip_address',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)

        # Adding field 'Controller.ip_address'
        db.add_column(u'machine_controller', 'ip_address',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transmitter.ip_address'
        db.delete_column(u'machine_transmitter', 'ip_address')

        # Deleting field 'Controller.ip_address'
        db.delete_column(u'machine_controller', 'ip_address')
