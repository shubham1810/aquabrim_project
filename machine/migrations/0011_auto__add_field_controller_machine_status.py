...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Controller.machine_status'
        db.add_column(u'machine_controller', 'machine_status',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Controller.machine_status'
        db.delete_column(u'machine_controller', 'machine_status')
    ...
    models = {
        ...
        u'machine.controller': {
            ...
            'machine_status': ('django.db.models.fields.CharField', [], {'max_length': '10'}),
            ...
            'timeout_interval': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
