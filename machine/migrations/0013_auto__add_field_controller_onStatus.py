...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Controller.onStatus'
        db.add_column(u'machine_controller', 'onStatus',
                      self.gf('django.db.models.fields.CharField')(default=1, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Controller.onStatus'
        db.delete_column(u'machine_controller', 'onStatus')
