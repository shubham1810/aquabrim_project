...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Controller.timeout_interval'
        db.add_column(u'machine_controller', 'timeout_interval',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Controller.timeout_interval'
        db.delete_column(u'machine_controller', 'timeout_interval')
