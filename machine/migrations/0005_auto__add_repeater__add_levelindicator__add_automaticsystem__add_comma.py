...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'machine_command', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('electronic_format', self.gf('django.db.models.fields.TextField')()),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal(u'machine', ['Command'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'machine_command')
    ...
    models = {
        ...
        u'machine.automaticsystem': {
            'Meta': {'object_name': 'AutomaticSystem'},
        ...
        u'machine.levelindicator': {
            'Meta': {'object_name': 'LevelIndicator'},
            'field_1': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'field_2': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        u'machine.multitankoption': {
            'Meta': {'object_name': 'MultiTankOption'},
            'field_1': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'field_2': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
